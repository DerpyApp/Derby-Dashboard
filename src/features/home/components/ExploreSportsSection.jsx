    ...
    <section className="w-full bg-[#121417] py-12">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
        ...
        <div className="relative">
          ...
          {/* Next Button Arrow */}
          <button className="hidden lg:flex absolute -right-4 top-1/2 -translate-y-1/2 w-9 h-9 bg-white text-black rounded-full items-center justify-center shadow-lg hover:bg-gray-200 transition">
